...
export default function Presentation() {
  return (
    <div className="w-[2600px] m-auto max-w-[90%] h-[70vh] items-center flex">
      <div className="grid grid-cols-12 justify-between w-full items-center">
        <div className="flex flex-col gap-3 col-span-5 max-[1500px]:col-span-12 max-[1500px]:text-center">
          <h1 className="text-9xl font-medium">CAMSA</h1>
          <h2 className="w-[70%] max-[1500px]:w-full">
            En <span className="text-blue-600">Camsa</span> encuentras planchas
            y equipos de estampado confiables, pensados para emprendedores,
